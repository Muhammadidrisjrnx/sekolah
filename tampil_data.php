...
<?php
include 'config.php';
$sql = "SELECT tb_siswa.id_verifikasi,tb_verifikasi.nama_verifikasi FROM tb_siswa inner join tb_verifikasi on tb_siswa.id_verifikasi = tb_verifikasi.id_verifikasi";
